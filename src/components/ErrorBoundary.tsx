...
import type { SystemError as LoggerSystemError } from '@/lib/types';
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  private reportError = (error: Error, errorInfo: ErrorInfo) => {
    ...
    // Log using structured logging service
  ...
  private reportToErrorService = async (error: SystemError) => {
    try {
      ...
      logger.warn('Failed to report error to service', {
      ...
      try {
        ...
        logger.warn('Failed to store error locally', {
          action: 'error_storage_failed',
