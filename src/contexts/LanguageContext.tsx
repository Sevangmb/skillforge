...
const getTranslations = (languageCode: string): TranslationData => {
...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    setLoadingTranslations(false);
  }, [user?.preferences?.language, getInitialLanguage]);
  ...
  const t = (key: string, params?: Record<string, string>): string => {
    ...
    let translation: TranslationData | string = activeTranslations;
